...
import { loadBlock, loadCompetitions } from "./api-client.js?v=0.7.2";
import { clearSelection, updateSourceGroupSelectedMarkers } from "./controls.js?v=0.7.2";
import { hideTip, renderContext, renderCoverage, renderHistogram } from "./delta-chart.js?v=0.7.2";
import { applyOutliersOpen, forgetScroll, renderOutliers, revealFocusedRow } from "./delta-outliers.js?v=0.7.2";
import {
  binKeyFor,
  clamp,
  computeBins,
  ...
  partitionByDelta,
  quantile,
} from "./delta-scales.js?v=0.7.2";
import { $, esc, matchesSourceFilter, parseEra, state } from "./frontend-state.js?v=0.7.2";
