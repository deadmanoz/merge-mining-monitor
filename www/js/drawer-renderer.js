import { blockExplorer } from "./explorer-links.js?v=0.7.13";
import { fmtDelta } from "./delta-scales.js?v=0.7.13";
import { $, chainDisplayName, CLASSIFICATION_META, esc, formatEpoch, formatScalar, formatSourceList, formatSourceRef, state } from "./frontend-state.js?v=0.7.13";
