import { loadTree, refreshActiveNavigatorTarget, renderUpdated } from "./api-client.js?v=0.7.7";
import { applyTreeHighlight, renderTreePanel } from "./controls.js?v=0.7.7";
import { $, DEFAULTS, esc, state } from "./frontend-state.js?v=0.7.7";
