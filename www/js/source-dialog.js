...
import { CHAIN_PROFILES, SOURCE_LIFECYCLE } from "./source-registry.generated.js?v=0.6.0";
import { esc, formatScalar, relativeTime, sourceChain } from "./frontend-state.js?v=0.6.0";
import { kvRows } from "./drawer-renderer.js?v=0.6.0";
import { sourceSyncLabel } from "./source-status.js?v=0.6.0";
