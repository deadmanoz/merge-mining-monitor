...
import { centerCameraOnHeight } from "./api-client.js?v=0.5.0";
import { state, writeForm } from "./frontend-state.js?v=0.5.0";
import { activateHeightLookup } from "./tree-query-state.js?v=0.5.0";
...
async function showInTree(height) {
  ...
  const shell = await import("./view-shell.js?v=0.5.0");
