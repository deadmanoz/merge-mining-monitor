...
import { centerCameraOnHeight } from "./api-client.js?v=0.7.3";
import { state, writeForm } from "./frontend-state.js?v=0.7.3";
import { activateHeightLookup } from "./tree-query-state.js?v=0.7.3";
...
async function showInTree(height) {
  ...
  const shell = await import("./view-shell.js?v=0.7.3");
