...
COMMENT ON TABLE bitcoin_core_header IS
  'Sparse canonical Bitcoin headers fetched from the required Core node: reorg-safe difficulty-epoch boundaries plus the replaceable current epoch and synced-tip horizon.';
